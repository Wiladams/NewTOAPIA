...
public class PixelBuffer : IPixelBuffer
{
    ...
    {
        GraphPort.SelectStockObject(GDI32.WHITE_PEN);
        GraphPort.SelectStockObject(GDI32.WHITE_BRUSH);
        GraphPort.Rectangle(0, 0, Width, Height);
    }

    public void ClearToBlack()
    {
        GraphPort.SelectStockObject(GDI32.BLACK_PEN);
        GraphPort.SelectStockObject(GDI32.BLACK_BRUSH);
        GraphPort.Rectangle(0, 0, Width, Height);
    }
