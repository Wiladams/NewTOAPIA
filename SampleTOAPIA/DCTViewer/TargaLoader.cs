...
namespace NewTOAPIA.Drawing
{
    ...
    {
        public static PixelArray CreatePixelDataFromFile(string filename)
        {
            int tgaSize;
            bool isExtendedFile;
            ...
            PixelLayout layout = PixelLayout.Bgr;   // Start out with BGR, but it could change
            switch (bytesPerPixel)
            {
                ...
                case 1:
                    layout = PixelLayout.Luminance;
                    break;
            }


            // Put the data into a pixel array
            PixelArray pixmap = new PixelArray(fHeader.Width, fHeader.Height, layout, PixelComponentType.Byte, 0, imageData, pixmapOrientation);
