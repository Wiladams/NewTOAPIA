...
public class FlagScene : GLModel
{
    ...
    GLColor ambientLight = new GLColor(0.4f, 0.4f, 0.4f, 1.0f);
    GLColor diffuseLight = new GLColor(0.7f, 0.7f, 0.7f, 1.0f);
    ...
    protected override void OnSetContext()
    {
        ...
        GI.Buffers.ColorBuffer.Color = new GLColor(0, 0, 0, 1);
