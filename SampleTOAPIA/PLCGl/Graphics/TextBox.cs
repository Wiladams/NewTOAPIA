...
public enum StringAlignment
{
	...
	public class TextBox : GLRenderable
    {
        #region Fields
        private GDIFont fFont;
        private string fFontName;
		private int fPointSize;
		private GDIFont.FontStyle fFontStyle;
        ...
        public TextBox(string aString, string aFontName, int pointSize, GDIFont.FontStyle style, 
        ...
        void CalculateTextOrigin()
        {
            ...
            int xCenter = (int)Origin.X + Frame.Width / 2;
            int yCenter = (int)Origin.Y + Frame.Height / 2;

            switch (fHAlignment)
            {
                case StringAlignment.Left:
                    fTextOrigin.X = (int)Origin.X;
                    break;
                ...
                case StringAlignment.Right:
                    fTextOrigin.X = (int)Origin.X + Dimension.Width - stringSize.Width;
                    break;
            }
            ...
            switch (fVAlignment)
            {
                ...
                case StringAlignment.Right:
                    fTextOrigin.Y = (int)Origin.Y + Dimension.Height - stringSize.Height;
                    break;
            }
