...
namespace PLC
{
	...
	/// a bunch of drawing.
	/// </summary>
	public class PLCView : GLRenderable //: ActiveArea
	{
		XmlNode fXmlData;
		...
		PLCColorScheme fCS;
		GLRenderable fLegend;

		string fEditionName;
		GLRenderable fTeamLogo;
		GLRenderable fTeamLogoBox;
		...
		public virtual GLRenderable Legend
		{
			get {return fLegend;}
			set 
			{
		...
		public virtual GLRenderable TeamLogo
		{
