namespace stdlib
{
    ...
    public static class Tools
    {
        ...
        internal static string ReplaceMetaCharsMatch(Match m)
        {
        ...
        #region FormatOCT
        internal static string FormatOct(string NativeFormat, bool Alternate,
        ...
        #endregion
        #region FormatHEX
        internal static string FormatHex(string NativeFormat, bool Alternate,
                                            int FieldLength, int FieldPrecision,
                                            bool Left2Right,
                                            char Padding, object Value)
        {
        ...
        #endregion
        #region FormatNumber
        internal static string FormatNumber(string NativeFormat, bool Alternate,
                                            int FieldLength, int FieldPrecision,
                                            bool Left2Right,
