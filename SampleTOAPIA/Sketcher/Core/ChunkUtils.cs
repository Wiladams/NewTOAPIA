...
namespace Sketcher.Core
{
    public static class ChunkUtils
    {
        ...
        //public override void CreateBrush(BrushStyle aStyle, HatchStyle hatch, uint color, Guid uniqueID)
        //{
        ...
        public static GDIPen UnpackGDIPen(BufferChunk chunk)
        {
            int command;
            uint penColor;
            PenStyle penStyle;
            ...
            command = chunk.NextInt32();
            penStyle = (PenStyle)chunk.NextInt32();
            penSize = chunk.NextInt32();
            penColor = chunk.NextUInt32();
            uniqueID = UnpackGuid(chunk);

            GDIPen aPen = new GDIPen(PenType.Cosmetic, PenStyle.Solid, PenJoinStyle.Round, PenEndCap.Round, penColor, 1, uniqueID);
