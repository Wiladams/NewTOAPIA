...
set "Args=%Args%&\"%INETROOT%\codebox\tools\runme-tfs.cmd\""
...
"%INETROOT%\codebox\tools\shortcut" /p:cmd.exe /n:"%ShortcutName%.lnk" /i:"%ProjectIcon%" /a:"%Args%" /d:"%ShortcutStartup%" /o:0
...
:NoTFS
@echo.
@echo Error! the VS80COMNTOOLS environment variable is not defined
