...
using TOAPI.Types;
    ...
    public class Region : IHandle
    {
        ...
        //  int nBottomRect);
        // [DllImport("gdi32.dll")]
        // static extern IntPtr CreateRectRgnIndirect([In] ref RectangleG lprc);
        // [DllImport("gdi32.dll")]
        ...
        // [DllImport("gdi32.dll")]
        // static extern IntPtr CreateEllipticRgnIndirect([In] ref RectangleG lprc);
        // [DllImport("gdi32.dll")]
        // static extern IntPtr CreatePolygonRgn(PointG[] lppt, int cPoints,
        //  int fnPolyFillMode);
        // [DllImport("gdi32.dll")]
        // static extern IntPtr CreatePolyPolygonRgn(PointG[] lppt, int[] lpPolyCounts,
        ...
        // [DllImport("gdi32.dll")]
        // static extern int GetRgnBox(IntPtr hrgn, out RectangleG lprc);
        // [DllImport("gdi32.dll")]
        ...
        // [DllImport("gdi32.dll")]
        // static extern bool RectInRegion(IntPtr hrgn, [In] ref RectangleG lprc);
    }
