...
namespace TOAPI.Types
{
	...
	public struct MSG
	{
		public IntPtr hWnd;
        public int message;
		public IntPtr wParam;   // public uint wParam
		public IntPtr lParam;   // public int lParam
		public int time;
		public POINT pt;
        ...
        // These are used with wm_xbuttonXXX messages
        ...
        public static string ToString(IntPtr hWnd, int msg, IntPtr wParam, IntPtr lParam)
        {
            ...
            + "' name='" + ID
            + "' hwnd='0x" + Convert.ToString(hWnd.ToInt32(), 16)
        ...
        public override string ToString()
        {
            ...
            if (Enum.IsDefined(typeof(WinMsg), message))
                return ((WinMsg)message).ToString();

            return ToString(hWnd, message, wParam, lParam);
        }
    ...
    public enum WinMsg : int
    {
        ...
        WM_SYSTIMER = 0x0118,       // Undocumented, see http://www.microsoft.com/msj/0397/hood/hood0397.aspx
