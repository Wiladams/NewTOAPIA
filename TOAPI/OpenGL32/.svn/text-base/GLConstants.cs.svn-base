...
{
    /// <summary>
    /// This file was generated in a brute force method by hand.  The Gl.h file was copied
    /// and statements removed, '=' and others added where necessary.
    /// The constants are roughly grouped into logical sections with some comments
    /// indicating usage.  
    /// For the most part, to use these constants, you already need to know OpenGL.
    /// They are here for convenience.
    /// </summary>
    public partial class glconstants
    {
        /* AccumOp */
        public const int
            GL_ACCUM                        =  0x0100,
