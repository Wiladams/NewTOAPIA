...
{
    public delegate void KeyboardActivityEventHandler(Object sender, KeyboardEvent ke);
                ...
                case MSG.WM_INPUT:
                    {
                            ...
                            (uint)Marshal.SizeOf(typeof(RAWINPUTHEADER))) == dwSize)
                        {
                            ...
                            {
                                KeyboardEvent kevent = new KeyboardEvent(this, (KeyEventType)raw.data.keyboard.Message, (VirtualKeyCodes)raw.data.keyboard.VKey, 0, '\0');
