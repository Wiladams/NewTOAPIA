...
namespace NewTOAPIA.Net.Rtp
{
    ...
    public class RtpEvents
    {
        ...
        public event AppPacketReceivedEventHandler AppPacketReceived;
        
        internal void RaiseAppPacketReceivedEvent(object[] args)
        {
            if(!FireEvent(AppPacketReceived, args))
            {
                //eventLog.WriteEntry(string.Format(CultureInfo.InvariantCulture, "AppPacketReceivedEvent"),
                //    EventLogEntryType.Information, (int)RtpEL.ID.AppPacketReceived);  // use string.Format to avoid CA1303 error
            }
        }
        ...
        /// </summary>
        public event InvalidPacketEventHandler InvalidPacket;

        internal void RaiseInvalidPacketEvent(object[] args)
        {
        ...
        /// </summary>
        public event NetworkTimeoutEventHandler NetworkTimeout;
        
        internal void RaiseNetworkTimeoutEvent(object[] args)
        {
        ...
        /// </summary>
        public event RtpParticipantAddedEventHandler RtpParticipantAdded;

        internal void RaiseRtpParticipantAddedEvent(object[] args)
        {
        ...
        /// </summary>
        public event RtpParticipantRemovedEventHandler RtpParticipantRemoved;
        
        internal void RaiseRtpParticipantRemovedEvent(object[] args)
        {
        ...
        /// </summary>
        public event RtpParticipantTimeoutEventHandler RtpParticipantTimeout;
        
        internal void RaiseRtpParticipantTimeoutEvent(object[] args)
        {
            RtpParticipantEventArgs ea = (RtpParticipantEventArgs)args[1];
        ...
        /// </summary>
        public event ReceiverReportEventHandler ReceiverReport;

        internal void RaiseReceiverReportEvent(object[] args)
        {
        ...
        public event RtpStreamAddedEventHandler RtpStreamAdded;
        
        //internal static void RaiseRtpStreamAddedEvent(object[] args)
        internal void RaiseRtpStreamAddedEvent(object[] args)
        {
        ...
        /// </summary>
        public event RtpStreamRemovedEventHandler RtpStreamRemoved;
        ...
        /// </summary>
        public event RtpStreamTimeoutEventHandler RtpStreamTimeout;
        
        internal void RaiseRtpStreamTimeoutEvent(object[] args)
        {
            RtpStreamEventArgs ea = (RtpStreamEventArgs)args[1];
