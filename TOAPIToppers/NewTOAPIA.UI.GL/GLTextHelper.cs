...
namespace NewTOAPIA.GL
{
    ...
    public class GLTextHelper
    {
        ...
        //public static void CreateBitmapFont(GraphicsInterface gr,
        //    GDIContext hdc,  // [in]
        ...
        //    result = wgl.wglUseFontBitmapsW(hdc.DangerousGetHandle(), 0, 255, bitmapFontOpenGLDisplayListBase);
        ...
        //public static void CreatePolygonFont(GraphicsInterface gr, GDIContext hdc, String fontName, ref uint GLDisplayListBase)
        //{
        ...
        //    result = wgl.wglUseFontOutlinesW(hdc.DangerousGetHandle(), 0, 255, GLDisplayListBase,
