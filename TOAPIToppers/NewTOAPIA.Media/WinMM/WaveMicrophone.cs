...
namespace NewTOAPIA.Media.WinMM
{
    ...
    public class WaveMicrophone : WaveInputPort, IDisposable
    {
        ...
        void AllocateBuffers(IntPtr devHandle)
        {
        ...
        public override void OnInputData(IntPtr wavhdrPtr, IntPtr param2)
        {
            if (wavhdrPtr == null)
            ...
            try
            {
                // Release the buffer from the audio system
                //aSample.Release(DeviceHandle);
