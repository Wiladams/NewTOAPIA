namespace NewTOAPIA.DirectShow.Core
{
	...
	public interface IBasicVideo
	{
		...
		[PreserveSig]
		int set_SourceLeft(int SourceLeft);
		...
		[PreserveSig]
		int set_SourceWidth(int SourceWidth);
		...
		[PreserveSig]
		int set_SourceTop(int SourceTop);
		...
		[PreserveSig]
		int set_SourceHeight(int SourceHeight);
		...
		[PreserveSig]
		int set_DestinationLeft(int DestinationLeft);
		...
		[PreserveSig]
		int set_DestinationWidth(int DestinationWidth);
		...
		[PreserveSig]
		int set_DestinationTop(int DestinationTop);
		...
		[PreserveSig]
		int set_DestinationHeight(int DestinationHeight);
