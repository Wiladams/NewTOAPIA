...
namespace NewTOAPIA.Graphics
{
    ...
    /// <summary>
    /// This class peforms color space conversions.  It will take RGB color values
    /// and turn them into Luminance values.  The Luminance is calculated assuming
    /// HDTV CRTs and Phosphors.
    /// 
    /// It operates by creating arrays of lookup values based on component contribution
    /// factors.  The actual conversion is a lookup in the arrays.
    /// </summary>
    public sealed class NTSCGray
    {
        // Based on old NTSC
