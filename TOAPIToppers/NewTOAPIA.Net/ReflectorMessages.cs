...
namespace NewTOAPIA.Net
{
    ...
    /// 1. Join - Sent from Client to Server to request joining a multicast group
    ...
    /// 8. InvalidRequest - Sent from Server to Client if the message type is neither Join nor Leave.
    /// </summary>
    public enum MessageType
    {
        ...
        Confirm, 
        ReConfirm, 
        LeaveWithoutJoinError, 
        ConfirmNumMismatchError, 
        UnknownError, 
        InvalidRequest
    };
