...
namespace NewTOAPIA.Drawing.GDI
{
    ...
    /// </summary>
    public class GDI32Transform
    {
        static GDI32Transform gIdentity;

        public XFORM fMatrix;
        float3x3 fTransformMatrix;

        public static GDI32Transform Identity
        {
            get
            {
                if (null == gIdentity)
                    gIdentity = new GDI32Transform();
                return gIdentity;
            }
        }
        ...
        public vec2 TransformPoint(vec2 aPoint)
        {
                             ...
                             float px1, float py1, float qx1, float qy1, float rx1, float ry1)
        {
            ...
            GDI32Transform map1 = new GDI32Transform();
